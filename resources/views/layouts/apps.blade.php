    ...
    <div class="sidebar pe-4 pb-3">
        <nav class="navbar navbar-light flex-column align-items-start w-100">
            ...
            <div class="navbar-nav w-100">
                <a href="{{ url('admin') }}" class="nav-item nav-link active">
                    <i class="fas fa-tachometer-alt me-2"></i>Dashboard
                </a>
                <a href="{{ url('assign') }}" class="nav-item nav-link">
                    <i class="fas fa-user-check me-2"></i>Assignment
                </a>
                <a href="{{ url('pending_cases') }}" class="nav-item nav-link">
                    <i class="fas fa-clipboard-list me-2"></i>Case Tracking
                </a>
                 <a href="{{ url('supervisor/suspects/pending') }}" class="nav-item nav-link">
                    <i class="fas fa-clipboard-list me-2"></i>Pending Supsects
                </a>
                 <a href="{{ url('all_cases') }}" class="nav-item nav-link">
                    <i class="fas fa-clipboard-list me-2"></i>All Cases
                </a>
