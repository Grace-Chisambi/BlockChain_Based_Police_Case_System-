    ...
    <div class="sidebar pe-4 pb-3">
        <nav class="navbar navbar-light flex-column align-items-start w-100">
            ...
            <div class="navbar-nav w-100">
                <a href="{{ url('admin/admin_dash') }}" class="nav-item nav-link active">
                    <i class="fas fa-tachometer-alt me-2"></i>Dashboard admin
                </a>
                <a href="{{ url('user_management') }}" class="nav-item nav-link">
                    <i class="fas fa-users me-2"></i>Users
                </a>
                <a href="{{ url('logs') }}" class="nav-item nav-link">
                    <i class="fas fa-file-alt me-2"></i>Logs & Audits
                </a>
