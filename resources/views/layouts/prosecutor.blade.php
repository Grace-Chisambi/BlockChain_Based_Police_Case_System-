    ...
    <div class="sidebar pe-4 pb-3">
        <nav class="navbar navbar-light flex-column align-items-start w-100">
            ...
            <div class="navbar-nav w-100">
                <a href="{{ url('prosecutor/dashboard') }}" class="nav-item nav-link active">
                    <i class="fas fa-tachometer-alt me-2"></i>Dashboard
                </a>
                <a href="{{ url('prosecutor/cases') }}" class="nav-item nav-link">
                    <i class="fas fa-briefcase me-2"></i>Assigned Cases
                </a>
                 <a href="{{ url('prosecutor/reports') }}" class="nav-item nav-link">
                    <i class="fas fa-folder-minus me-2"></i>Case Reports
                </a>
                 <a href="{{ url('prosecutor/appearances') }}" class="nav-item nav-link">
                    <i class="fas fa-folder-minus me-2"></i>Court Appearances
                </a>
                <a href="{{ url('prosecutor/case_closures') }}" class="nav-item nav-link">
